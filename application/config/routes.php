...
//$route['affiliateSignup']	= '/Affiliatepartner/affiliateSignup';
$route['affilaitepartnership']	= '/Affiliatepartner/affiliateSignup';



$route['affiliateMap']	= '/Affiliatepartner/affiliateMap';
$route['affiliatePQR']	= '/Affiliatepartner/affiliatePQR';
