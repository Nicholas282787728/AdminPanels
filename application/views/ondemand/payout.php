                ...
                <div class="col-sm-6">
      						<div class="col-sm-12">
      							<div class="form-group">
      								...
      								<input class="form-control"  name="bank_name" autocomplete="off" value="<?=$bank_name?>" type="text" placeholder="Name of Bank" required="">
      							</div>
      						</div>
      						<div class="col-sm-12">
      							<div class="form-group">
      								<label>Bank Account Number</label>
      								<input class="form-control" name="info_form" autocomplete="off" value="<?=$info_form?>" type="text" placeholder="Bank Account Number" required="">
      						...
      						<div class="col-sm-12">
      							<div class="form-group">
      								<label>Bank Routing Number</label>
      									<input class="form-control" name="info_banking" autocomplete="off" value="<?=$info_banking?>" type="text" placeholder="Bank Routing Number" required="">
      							</div>
      						</div>               
      						<div class="col-sm-12">
      							<div class="form-group ">
      								<label>Paypal Name</label>
      									<input class="form-control" name="paypal_name" autocomplete="off" value="<?=$paypal_name?>" type="text" placeholder="Paypal Name" required="">
      							</div>
      						</div>
      						<div class="col-sm-12">
      							<div class="form-group ">
      								<label>Paypal Email </label>
      									<input class="form-control" name="paypal_email" autocomplete="off" placeholder="Paypal Email" value="<?=$paypal_email?>" type="text" required="">
      							</div>
      						</div> 
					      </div>
