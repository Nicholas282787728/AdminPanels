    <br>
       ...
       <div class="row-fluid sortable">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal validatedForm" role="form" name="settings" action="<?php echo base_url(); ?>panels/supermacdaddy/ondemand/updatePassword" method="post" novalidate="novalidate">
