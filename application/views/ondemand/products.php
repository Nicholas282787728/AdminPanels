        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <button type="button" class="btn-green" data-toggle="modal" data-target="#exampleModalAdd" style="text-transform: lowercase;">Add New Products</button>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
									...
									<td><img src="<?php  echo $imagUrl; ?>" width="150px" height="150px"></td> 
        ...
        <div class="col-sm-6">
         ...
         <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-language"></i></span>
                    <input class="form-control k6" name="k6" autocomplete="off" placeholder="180$" type="text" >
                </div>
            </div>
        </div>
