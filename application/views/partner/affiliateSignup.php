...
p.trns {
        ...
        <div id="wrapper" class="toggled">
         ...
         <?php $this->load->view('side_menu'); ?> 
			...
			<section class="tabbing">
				<div class="row">
					<div class="col-md-12">
						<nav class="affiliate-tabbing-nav">
		                    <ul class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
		                      	<li class="active"><a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Available Markets</a></li>
		                      	<li><a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Qualification Requirements</a></li>
		                      	<li><a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Affliate Applications</a></li>
		                    </ul>
	                  	</nav>
					</div>
				</div>
							...
							<div class="container">
								<div class="row">
									<div class="col-md-12">
										<div class="section-title st-center">
											<!--<h3>What we do</h3>-->
											<p class="title-heading font-century text-capitalize" data-trn-key="menu_service">Partnership Qualifications & Requirements</p>
											<!-- <a href="#" onclick="goToSignUp()" class="btn btn-main btn-lg left-btn">Sign Up</a> -->
										</div>
										<div class="block partnershp-requirements">
											<div class="signup-container">
												<div class="col-md-4">
													<div class="col-md-12 img-sec text-center">
														<img src="<?php echo base_url('public/images/req-1.png');?>" />
														<h4 class="font-century">Support</h4>
													</div>
													<ol>
												...
												<div class="col-md-4">
													<div class="col-md-12 img-sec text-center">
														<img src="<?php echo base_url('public/images/req-2.png');?>" />
														<h4 class="font-century">Marketing</h4>
													</div>
													<ol>
												...
												<div class="col-md-4">
													<div class="col-md-12 img-sec text-center">
														<img src="<?php echo base_url('public/images/req-3.png');?>" />
														<h4 class="font-century">Training</h4>
													</div>
													<ol>
							...
							<div class="container">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="block partnershp-requirements-2">
											<div class="signup-container">
												<div class="col-md-6">
													<div class="section-title">
														<p class="text-pink text-capitalize font-century">Pre-Qualifications</p>
													</div>
													<div class="content">
														<p>Have ‘’Good’’ credit</p>
														<p>Service in any branch of the U.S. 
														military is +</p>
														<p>Not have filed for bankruptcy within 
														the last (7) years</p>
														<p>Understand the need to be involved 
														in the day-to-day operation of a small 
														business</p>
														<p>Must have at least (3) years’ experience 
														in running an established retail, business 
														operations or (7) years’ of management 
														experience</p>
														<p>Have no prior record of felony 
							...
							<div class="container">
								<div class="row">
									<div class="col-md-12">
										<div class="section-title st-center">
											<!--<h3>What we do</h3>-->
											<p class="title-heading font-century text-capitalize" data-trn-key="menu_service">Applicants must complete Enrollment Application & comply  with Licensing Requirements</p>
											<!-- <a href="#" onclick="goToSignUp()" class="btn btn-main btn-lg left-btn">Sign Up</a> -->
										</div>
										<div class="block partnershp-requirements-2">
											<div class="signup-container">
												<div class="col-md-12">
													...
													<div class="content">
														<p>Applicant must have experience in running an established dispensary/storefront at multiple locations.</p>

														<p>Applicant must show willingness to learn and adapt to our operating procedures as well as pass initial and post interviews.</p>

														<p>Applicant must provide list of previous work/ business history especially if it pertains to the marijuana industry, or mobile industry.</p>

														<p>Applicant must provide full disclosure on business sales and current expenses, along with information pertaining to any litigations/arbitrations including any current/active business partners.</p>
													</div>
												</div>							
											</div>
										</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="block typeOfServices">
										<form method="post"  action="<?php echo base_url(); ?>Affiliatepartner/upload_signup" enctype="multipart/form-data">
											<div class="signup-container">
												<ul>
													<li>
															...
															<div class="row">
																<div class="col-md-4">														
																	<div class="form-group">
																		...
																		<input type="text" name="user_name" placeholder="Legal First Name :" class="form-control" required="">
																		<input type="hidden" name="user_type" value="10">
																	</div>
																	<div class="form-group">
																		<label>*Mobile Number :</label>
																		<input type="text" name="mob_number" placeholder="Mobile Number :" class="form-control" required="">
																	</div>
																	<div class="form-group">
																		<label>*Street Number :</label>
																		<input type="text" name="street_num" placeholder="Street Number :" class="form-control" required="">
																	</div>
																	<div class="form-group">
																		<label>*Country :</label>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<input type="text" name="middle_name" placeholder="Legal Middle Name :" class="form-control" required="">
																	</div>
																	<div class="form-group">
																		<label>*Alternate Number :</label>
																		<input type="text" name="alternate_num" placeholder="Alternate Number :" class="form-control" required="">
																	</div>
																	<div class="form-group">
																		<label>*Street Name :</label>
																		<input type="text" name="street" placeholder="Street Name :" class="form-control" required="">
																	</div>
																	<div class="form-group">
																		<label>*State / Number :</label>
																		<div class="stateDiv"> 
																			<select name="state"  class="form-control statelist" id="state_list" >
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<input type="text" name="last_name" placeholder="Legal Last Name :" class="form-control" required="">
																	</div>
																	<div class="form-group">
																		<label>*Email :</label>
															...
															<div class="row">
																<div class="col-md-6">
																	<form class="form-horizontal col-md-12">
																		...
																		<div class="form-group">
																			...
																			<input type="text" name="residency_state" placeholder="Zip Code :" class="form-control" required="">
																		</div>
																		<div class="form-group">
																			<label>*Are you a U.S. military veteran? </label><br>
																			<label class="radio-inline"><input type="radio" name="military_veteran" value="1" checked>Yes</label>
																			<label class="radio-inline"><input type="radio" name="military_veteran" value="0" >No</label>
																		</div>
																		<div class="form-group">
																			...
																			<!-- <select name="" class="form-control">
																				...
																				<input type="text" name="military_status"  class="form-control"  >
																		</div>
																		<div class="form-group">
																		...
																		<!-- 	<select name="" class="form-control">
																				...
																				<input type="text" name="retail_experience"  class="form-control" required="">
																		</div>
																		<div class="form-group">
																		...
																		<!-- 	<select name="" class="form-control">
																			...
																			<input type="text" name="management_experience"  class="form-control" required="">
																		</div>
																		<div class="form-group">
																			<label>*Do you have firing or hiring experience?</label><br>
																			<label class="radio-inline"><input type="radio" name="firing_or_hiring_experience" value="1" checked>Yes</label>
																			<label class="radio-inline"><input type="radio" name="firing_or_hiring_experience" value="0" >No</label>
																		</div>
																		<div class="form-group">
																			<label>*Describe how you will operate your business :</label>
																			<textarea name="operate_your_business" class="form-control" placeholder="Describe how you will operate your business" required=""></textarea>
																		</div>
																		<div class="form-group">
																			<label>*Describe your experience and qualification :</label>
																			<textarea name="experience_and_qualification" class="form-control" placeholder="Describe how you will operate your business" required=""></textarea>
																		</div>
																		<div class="form-group">
																		...
																		<!-- 	<select name="" class="form-control">
																			...
																			<input type="text" name="business_opportunity"  class="form-control" required="">
																		</div>
																		<div class="form-group">
																		...
																		<!-- 	<select name="" class="form-control">
																				<option>Select</option>
																					...
																					<input type="text" name="investment_is_liquid"  class="form-control">
																		</div>
																		<div class="form-group">
																			<label>*Are you able to dedicate full-time managing and working at the store? :</label><br>
																			<label class="radio-inline"><input type="radio" name="managing_and_working" value="1" checked>Yes</label>
																			<label class="radio-inline"><input type="radio" name="managing_and_working" value="0" >No</label>
																		</div>
																		<div class="form-group">
																		...
																		<!-- 	<select name="" class="form-control">
																				<option>Select</option>
																					...
																					<input type="text" name="area_of_interest"  class="form-control" required="">
																...
																<div class="col-md-6">
																		...
																		<div class="form-group">
																			...
																			<label class="radio-inline"><input type="radio" name="ontracted_by_Med_ConnixApp" value="1" checked>Yes</label>
																			<label class="radio-inline"><input type="radio" name="ontracted_by_Med_ConnixApp" value="0" >No</label>
																		</div>
																		<div class="form-group">
																			<label>Address of store or store number(s) :</label>
																			<textarea name="store_number" class="form-control" placeholder="Address of store or store number(s)"></textarea>
																		</div>
																		<div class="form-group">
																			<label>*Will your spouse be on  Med ConnixApp?</label><br>
																			<label class="radio-inline"><input type="radio" name="spouse_be_on_Med_ConnixApp" value="1" checked>Yes</label>
																			<label class="radio-inline"><input type="radio" name="spouse_be_on_Med_ConnixApp" value="0" >No</label>
																		</div>
																		<div class="form-group">
																			<label>Spouse First Name :</label>
																			<input type="text" name="Spouse_First_Name" class="form-control" placeholder="Spouse First Name">
																		</div>
																		<div class="form-group">
																			<label>Spouse Middle Name :</label>
																			<input type="text" name="Spouse_Middle_Name" class="form-control" placeholder="Spouse Middle Name">
																		</div>
																		<div class="form-group">
																			<label>Spouse Last Name :</label>
																			<input type="text" name="Spouse_Last_Name" class="form-control" placeholder="Spouse Last Name">
																		</div>
																		<div class="form-group">
																			<label>*Spouse Date of Birth (mm/dd/yyyy) :</label>
																			<input type="text" name="Spouse_Date_of_Birth" class="form-control" required="" id="datepicker1">
																		</div>
													...
													<li>
														...
														<div class="col-md-12">
															...
															<div class="form-group">
																<div class="checkbox">
																  	<label><input type="checkbox" required="">*I/WE Agree</label>
																</div>
															</div>
															<div class="form-group">
																<label>*Applicant’s Signature :</label>
																<input type="text" name="Applicant_s_Signature" class="form-control" placeholder="Applicant’s Signature" required="">
															</div>
														</div>
													</li>
													<li>
														<div class="col-md-12">
															<button type="submit" class="btn btn-primary btn-green affliatebtn">Submit</button>
															<button class="btn btn-primary btn-pink affliatebtn">Reset</button>
														</div>
													</li>
												</ul>
											</div>
 ...
 setTimeout(function(){ $('.storeFrontsSignUpclose').trigger('click'); }, 100);
		...
		<script type="text/javascript">
			...
			$.ajax({
				type: "post",
				url: "<?php echo base_url();  ?>Affiliatepartner/getStates",
				...
				success: function (response)
				{
						...
						json_obj.forEach(ele => {
							$('#state_list').append(`<option value="${ele.id}">${ele.name}</option>`);
						});
        		}
			});
		});
		...
		<script type="text/javascript">
			...
			$.ajax({
				type: "post",
				url: "<?php echo base_url();  ?>Affiliatepartner/getCity",
				...
				success: function (response)
				{
						...
						console.log(json_obj);
						json_obj.forEach(ele => {
							$('#city_list').append(`<option value="${ele.id}">${ele.name}</option>`);
						});
        		}
			});
		});
