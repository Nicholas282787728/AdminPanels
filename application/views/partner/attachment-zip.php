								...
								<td >
									 ...
									 <?php
										...
										<?php
											  ...
											  <div>&nbsp;</div>
											<a onmouseover="this.style='color:#fff;';" target="_blank" href="<?php echo base_url(); ?>uploads/<?php echo $row['upload_file']; ?>" >
												<span class="label label-success">Word Document</span>
						...
						<!-- 		
								...
								<td>
										...
										<ul class="dropdown-menu" role="menu">
											<li>
											<button style="padding: 4px 10px;border: none;background: transparent;" type="button" data-toggle="modal" data-target="#view<?php echo $row['zip_id']; ?>" >
											<i class="fa fa-minus-circle"></i>  view 
											</button>
											</li>
													<!-- <li>	
														<button style="padding: 4px 10px;border: none;background: transparent;" onclick="myFunction()"><i class="fa fa-minus-circle"></i>Print</button>
										...
										?>
											...
											<a href="<?php echo base_url(); ?>uploads/<?php echo $row['upload_file']; ?>" download>Download</a>
										...
										<?php
											...
											<form method="post" action="<?php echo base_url(); ?>uploads/<?php echo $row['upload_file']; ?>" >
													<button style="padding: 4px 10px;border: none;background: transparent;" type="submit"  >
											<i class="fa fa-minus-circle"></i>  Download 
											</button>
											</form>
							...
							<div class="modal fade" id="view<?php echo $row['zip_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header title-bar-orange">
				<h5 style="color:#fff;width:93%;float:left;font-weight: bold;" class="modal-title" id="exampleModalLabel"><i class="fa fa-envelope"></i> View</h5>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="input-group" style="width: 100%;">
									<input type="text" value="<?php echo $row['title']; ?>" class="form-control">
							...
							<div class="form-group" style="overflow-y: auto;">
								...
								<div class="input-group" >
									<img src="<?php echo base_url(); ?>uploads/<?php echo $row['upload_file']; ?>" class="shareImage">
								</div>
							</div>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="form-group" style="overflow-y: auto;">
								...
								<div class="input-group" >
									<img src="" class="shareImage" name="image">
								</div>
							</div>
