...
p.trns {
    ...
    display: none;">
						...
						<div class="col-md-12 text-center">
							<div class="st-home-unit-2" style="padding: 50px 0;position: relative;margin-top: 5em;margin-bottom: 8.5em;z-index: 2;">
								...
								<div class="hero-txt main-nav">
									<h2 class="hero-title trns"  data-trn-key="main_sub_title">"Connecting Patients Nationwide"</h2>
							...
							<div class="col-md-12">
								...
								<div class="">
									<div class="text-center">
										<a data-toggle="modal" data-target="#OnDemandSignUp1">
											<img src="<?php echo base_url(); ?>public/images/Driver17.jpg" alt="Get Started With Med Connex" style="width: 100%;cursor:pointer;">
										</a>
									</div>
								</div>
							</div>
		...
		<!-- 	<section class="call-us">
				...
				<div class="container">
					...
					<div class="block">
						<div class="col-md-6">
							...
							<form  method="post" action="home/contctus"  class="form-horizontal">
								<!-- <div class="form-group">
							...
							<!-- 		</div>
								...
								<div class="form-group">
									<label class="control-label col-sm-3" for="subj">Subject:</label>
									<div class="col-sm-9"> -->
										<input type="text" class="form-control" id="subj" name="subj" placeholder="Subject" required>
									<!-- </div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3" for="mssg">Your Message:</label>
									<div class="col-sm-9"> -->
						...
						<div class="col-md-6">
							<p class="trns" data-trn-key="contact_touch">
								<!-- Do you need some information about Med Connex or are you looking for some help regarding our products and services? -->
								Do you need some additional information about Med Connex Mobile App or services we offer? Are you a provider and interested in joining our platform?
							</p><br>
							<p class="trns" data-trn-key="contact_touch_1">
								...
								Feel free to contact us via phone at any of the numbers listed below or email us and will make sure to follow up as soon as possible.
							</p><br>
							<address>
								<strong style="color: #000 !important">Customer Service: </strong><span><b style="color:#0cb3ac;"> 415-659-8420</b></span><br>
								<strong style="color: #000 !important">Email: </strong><span><b style="color:#1DAA4A!important;"><a href="mailto:sales@medconnex.com" target="_top">sales@medconnex.net</a></b> / <b style="color:#1DAA4A!important;"><a href="mailto:info@medconnex.com" target="_top">info@medconnex.net</a></b></span>
			...
			<div class="col-md-12">
				<ul class="nav nav-tabs">
			 	    <li class="active"><a data-toggle="tab" href="#home1">Web Use Agreement</a></li> 
				    <li><a class="active" data-toggle="tab" href="#menu1">Mobile App Agreement</a></li>
				     <li><a data-toggle="tab" href="#menu2">COINS/Referral Agreement</a></li> 
			  	</ul>
			  	<div class="tab-content">
	 			    <div id="home1" class="tab-pane fade in active">
				      <ul class="TermsAndCondtions">
				      	<?php foreach ($getTermsAndCondtionWebs as $row) {

				      		?>
				      		  	<li><a href="javascript:void[0];" data-toggle="modal" data-target="#TermsAndCondtionWebs<?php echo $row['id']; ?>"><?php echo $row['state_id']; ?></a></li>

				      		  	<div class="modal fade" id="TermsAndCondtionWebs<?php echo $row['id']; ?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Web Use Agreement</h4>
        </div>
        <div class="modal-body">
          <p><?php echo $row['state_id']; ?></p><br>
            <p><?php echo $row['content']; ?></p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				    ...
				    <div id="menu1" class="tab-pane fade in active">
				     <ul class="TermsAndCondtions">
				      	<?php foreach ($getTermsAndCondtionapps as $row) {

				      		?>
				      		  	

				      		  	   	
				      		  	   		  		<li><a href="javascript:void[0];" data-toggle="modal" data-target="#TermsAndCondtionapps<?php echo $row['id']; ?>"><?php echo $row['state_id']; ?></a></li>

				      		  	<div class="modal fade" id="TermsAndCondtionapps<?php echo $row['id']; ?>" role="dialog">
    <div class="modal-dialog">
    
          <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Mobile App Agreement</h4>
        </div>
        <div class="modal-body">
          <p><?php echo $row['state_id']; ?></p><br>
            <p><?php echo $row['content']; ?></p>
		...
		<section class="agreements">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<ul class="nav nav-tabs">
			 	    		<li ><a href="javascript:void[0];" data-toggle="modal" data-target="#TermsAndCondtionWebs">Web Use Agreement</a></li> 
				     		<li><a href="javascript:void[0];" data-toggle="modal" data-target="#TermsAndCondtionWebs">COINS/Referral Agreement</a></li> 
			  			</ul>
					  	<div class="modal fade" id="TermsAndCondtionWebs" role="dialog">
						    <div class="modal-dialog">
						      	<div class="modal-content">
							        <div class="modal-header">
							          <button type="button" class="close" data-dismiss="modal">&times;</button>
							          <h4 class="modal-title">Term & Condtions</h4>
							        </div>
							        <div class="modal-body">
							     <!--      <p><?php echo $row['state_id']; ?></p><br>  -->
							            <p>KEEP THIS SECTION OF TERMS & CONDITIONS, KEEP THIS SECTION OF TERMS & CONDITIONS , KEEP THIS SECTION OF TERMS & CONDITIONS , KEEP THIS SECTION OF TERMS & CONDITIONS, KEEP THIS SECTION OF TERMS & CONDITIONS, KEEP THIS SECTION</p>
							        </div>
							        <div class="modal-footer">
							          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
							        </div>
		...
		<div id="myModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
	             <div class="modal-content mainbox" >
						<!--  <div class="modal-body" style="height: 120px; display: flex;align-items: center;">	
								<div class="col-md-12 selectSignTypo flashScreen" >
									<div class="col-md-6">
										<input type="button"  name="signup" value="Download the App" data-toggle="modal" data-target="#myModal112" class="btn btn-main btn-lg btn-success btn-info  ">
									</div>
									<div class="col-md-6">
										<input type="button"  value="Certified Provider " data-toggle="modal" data-target="#myModal111" class="btn btn-main btn-lg btn-success btn-info  ">
									</div>
								</div>
