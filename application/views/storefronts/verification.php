...
//echo "<pre>"; print_r($alluser);
								...
								<!-- 	<td><?php $adid = $val['advertisment_id'];?> -->
									<!-- <img width="150px" src="https://medconnex.net/demonil/uploads/<?php echo $resultarray->ad_image; ?>"> -->
		<!-- 								<?php  $sql = "SELECT ad_image from sal_advertisement where ad_id = '$adid'";
...
<script type="text/javascript">
 ...
 var seeStatusId = jQuery(this).attr('data-id'); 
      ...
      jQuery.ajax({    //create an ajax request to display.php
        type: "POST",
        url: "https://medconnex.net/demonil/storefronts-verification",             
