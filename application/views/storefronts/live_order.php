                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li style="display:none">
                                                     ...
                                                     <li>
                                                        <form method="post">
                                                           <input type="hidden" name="user_id" value="'.$sale['orderUser'].'" >
                                                        <button type="submit" name="" value="'.$sale['id'].'"class="js-user-activate" style="padding: 1px 10px;border: none;background: transparent;">
                                                        <i class="fa fa-bolt"></i> Currently in Route
                                                        </a>
                                                        </form>
                                                    </li>
