		...
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form id="form_data" name="user" method="post" action="<?=base_url()?>panels/supermacdaddy/storefronts/visibility_action" enctype="multipart/form-data"  novalidate="novalidate" onsubmit="return false;">
...
<?php  $emailData = $this->session->userdata('username');
$name = $this->session->userdata('name');
								...
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<input class="form-control" name="paypal_business" autocomplete="off" placeholder="" type="text" value="<?php echo $name; ?>" >
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<input class="form-control" name="paypal_id" autocomplete="off" placeholder="" type="text" value="<?=$paypal_clientid?>" >
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<input class="form-control" name="email" autocomplete="off" type="email" required="" value="<?php echo $emailData; ?>">
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<input class="form-control" name="patient_tax" autocomplete="off" placeholder=""  type="text" value="<?=$patient_tax?>">
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control" name="adult_use_tax" autocomplete="off" type="text" value="<?=$adult_use_tax?>">
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<input class="form-control" name="latitude" id="latitude" autocomplete="off" placeholder="" type="text" required value="<?=$latitude?>">
									</div>
								</div>
								...
								<div class="col-sm-6 ">
									<div class="form-group ">
										...
										<input class="form-control" name="longitude" id="longitude"  autocomplete="off" placeholder="" type="text" required value="<?=$longitude?>">
									</div>
								</div>
						...
						<div class="row modal-footer">
							<div class="creatUserBottom ">
										...
										?>
										<?php
										// echo "<pre>"; print_r($getOpt);

										// die(); 
										
										if($getOpt->opt_in_out == '1'){
											?>
											<button type="button"  data-target="#opt_inout_msg"	 data-toggle="modal"  class="btn-green opt_btn  blink_me">OPT In</button>
											<?php
										} 
										else  {
											?>
											<button  type="button"   data-target="#opt_inout_msg" data-toggle="modal"  data-val="0" class="btn-green   blink_me">OPT Out</button>
											<?php
										} ?>
			...
			<div class="modal-body">
				...
				<div style="margin-top:15%" align="center">
						...
						<?php
							if($getOpt->opt_in_out == '1'){
							?>
						<form action="https://medconnex.net/demonil/panels/supermacdaddy/Storefronts/opt_in_out_status" method="post">
							<input type="hidden" name="opt_in_out" value="0">
						
							<button  type="submit"  class="btn-green blink_me" style="width:30%;">OPT In</button>
							</form>
							<?php
							} 
							else  {
							?>
							<form action="https://medconnex.net/demonil/panels/supermacdaddy/Storefronts/opt_in_out_status" method="post">
							<input type="hidden" name="opt_in_out" value="1">
						<button  type="submit"  class="btn-green blink_me" style="width:30%;">OPT Out</button>
					</form>
							<?php
							}
							 ?>
