		...
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form name="user" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>panels/supermacdaddy/storefronts/<?=!empty($checkava)?'updateComp':'add_insertComp'?>" novalidate="novalidate">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<select class="form-control" name="ad_size" required="" id="ad_size">
											...
											<option value="220x330" <?=($comp->ad_size =="220x330" )?'selected':'';?> >220 x 330</option>
											<?php	
											}
											else
											{
											...
											<option value="220x330">220 x 330</option>
											<?php
											}
											?>
        ...
        readURL(this);
			...
			<script>
				...
				$("#create_taskimage").change(function () {
						...
						$.ajax({
							type:'POST',
							url:"<?php echo base_url();?>panels/supermacdaddy/storefronts/temp_view",
							data: formData,
							cache:false,
							contentType: false,
							processData: false,
