...
<!--<link rel="stylesheet" href="<?php echo base_url(); ?>public/sales-design/assests/css/menu.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/sales-design/assests/css/custom.css">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="sup-head">
                        <div class="support-img pull-left">
                            <img src="<?php echo base_url(); ?>public/images/ticket.png" alt="" style="width: 150px;">
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-10 col-sm-12 col-xs-12">
                        <div class="menu-bd">
                            <ol class="breadcrumb">
                                <li><a href="<?php echo base_url(); ?>panels/supermacdaddy/sales">Home</a>
                                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 copy-right" align="center">
                    <p>Copyright @ <?php echo date('Y')?> Medconnex - All rights reserved.</p>
                </div>
            </div>
        </div>
    </section>
						...
						<div class="col-sm-12">
							<div class="form-group">
							 ...
							 <div class="form-group">
								<label for="email">Email Address</label>
								<div class="input-group">
								<input type="email" class="form-control" id="email" name="ticket_email" value="support@medconnex.net" readonly="" style="width:530px !important;"  required="">
								</div>
							</div>
